...
import { createWidgetFromSession } from '../../../../lib/database'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await createWidgetFromSession(config.sessionId, {
      ...
      business_name: config.business_name || 'Demo Company',
    ...
    const embedCode = generateWidgetScript(result.widget, baseUrl)
    
    console.log('Widget generated:', {
      widgetKey: result.widgetKey,
      baseUrl,
      hasEmbedCode: !!embedCode,
      embedCodeLength: embedCode.length
    })
    ...
    return NextResponse.json({
      ...
      widgetKey: result.widgetKey,
      embedCode,
      scriptUrl: `${baseUrl}/api/widget/script/${result.widgetKey}`,
    })
  } catch (error) {
...
function generateWidgetScript(widget: any, baseUrl: string): string {
  return `
<!-- AI Support Widget (Generated by AI Support Bot) -->
<script>
(function() {
